...
## DAVIS_valid = [122.7175, 120.6902, 117.5148]
## DAVIS_Train = [115.3562, 113.7146, 105.0861]
...
_C.MODEL.ROI_HEADS.DETECTIONS_PER_IMG = 30
...
# ---------------------------------------------------------------------------- #
# Specific Fine tune 1st frame options in Test
# ---------------------------------------------------------------------------- #
_C.FINETUNE = CN()
_C.FINETUNE.USE = False
_C.FINETUNE.TOTAL_ITER = 0
